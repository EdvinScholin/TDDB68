...
#pintos -v --qemu -- run 'lab4test1 arg1 arg2 arg3 arg4'
...
pintos -v -k -T 60 --qemu --gdb --fs-disk=2 -p tests/userprog/exec-arg -a exec-arg -p tests/userprog/child-args -a child-args -- -q   -f run exec-arg